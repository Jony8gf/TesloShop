...
export const initialData: SeedData = {
    users:[
        ...
        {
            name: 'Jacobo',
            email: bcrypt.hashSync('jacobo@gmail.com'),
            password: '123456',
            role: 'client'
        }
    ],
    products: [
        ...
        {
            description: "Introducing the Tesla Chill Collection. The Woman's Chill Half Zip Cropped Hoodie has a premium, soft fleece exterior and cropped silhouette for comfort in everyday lifestyle. The hoodie features an elastic hem that gathers at the waist, subtle thermoplastic polyurethane Tesla logos along the hood and on the sleeve, a double layer single seam hood and a custom ring zipper pull. Made from 60% cotton and 40% recycled polyester.",
            images: [
        ...
        {
            description: "Introducing the Tesla Raven Collection. The Woman's Raven Slouchy Crew Sweatshirt has a premium, relaxed silhouette made from a sustainable bamboo cotton blend. The slouchy crew features a subtle thermoplastic polyurethane Tesla wordmark on the left sleeve and a french terry interior for a cozy look and feel in every season. Pair it with your Raven Joggers or favorite on the go fit. Made from 70% bamboo and 30% cotton.",
            images: [
        ...
        {
            description: "Designed for style and comfort, the ultrasoft Woman's T Logo Short Sleeve Scoop Neck Tee features a tonal 3D silicone-printed T logo on the left chest. Made of 50% Peruvian cotton and 50% Peruvian viscose.",
            images: [
        ...
        {
            description: "Designed for style and comfort, the ultrasoft Woman's T Logo Long Sleeve Scoop Neck Tee features a tonal 3D silicone-printed T logo on the left chest. Made of 50% Peruvian cotton and 50% Peruvian viscose.",
            images: [
        ...
        {
            description: "Designed for style and comfort, the Woman's Small Wordmark Short Sleeve V-Neck Tee features a tonal 3D silicone-printed wordmark on the left chest. Made of 100% Peruvian cotton.",
            images: [
        ...
        {
            description: "Designed for style and comfort, the Woman's Large Wordmark Short Sleeve Crew Neck Tee features a tonal 3D silicone-printed wordmark across the chest. Made of 100% Peruvian pima cotton.",
            images: [
        ...
        {
            description: "Fully customized and uniquely styled, the Woman's Corp Jacket features a silicone-printed 'T' logo on the left chest and prominent Tesla wordmark across the back.",
            images: [
